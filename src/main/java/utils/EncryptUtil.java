...
public class EncryptUtil {
	...
	public static void main(String[] args) {
		try {
			String test = "http://invoicefileservice.bjzsxx.com/440300/201806/26/91440300319797090X/201806/27/1/04403180011104490916.pdf";
			String key ="8ef1b6e75";		// 自定义密钥9ba45bfd500642328ec03ad8ef1b6e75
			EncryptUtil des = new EncryptUtil(key, "utf-8");
			String url="http://www.baidu.com/page="+ des.encode(test);
			System.out.println("得到访问地址：" +url);
			System.out.println("获取参数得到实际的地址：" + des.decode(des.encode(test)));
		} catch (Exception e) {
			e.printStackTrace();
		}
